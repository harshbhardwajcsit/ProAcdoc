...
public class AddNewMemberCityDialougeFragment extends DialogFragment {
...
JSONArray cityArray=response.getJSONArray("Items");
    ...
    mAdapter = new AddNewMemberCityAdapter(mContentItems, getActivity().getApplicationContext());
