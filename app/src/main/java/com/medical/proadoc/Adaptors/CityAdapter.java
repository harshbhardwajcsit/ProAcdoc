...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.SimpleItemViewHolder> {
    ...
    public CityAdapter(List<CityModel> items, Context context) {
        this.items = items;
    ...
    public void onBindViewHolder(SimpleItemViewHolder viewHolder, final int position) {
        ...
        viewHolder.llCountryRow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Register.dFragment.dismiss();
                Register.editTextCity.setText(items.get(position).getCityName());
                Register.CityId= items.get(position).getCityId();
